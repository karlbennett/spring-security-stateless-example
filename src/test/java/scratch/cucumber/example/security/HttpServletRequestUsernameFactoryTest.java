...
public class HttpServletRequestUsernameFactoryTest {

    private static final String X_AUTH_TOKEN = "X-AUTH-TOKEN";

    private TokenFactory tokenFactory;
    private HttpServletRequestUsernameFactory factory;

    @Before
    public void setUp() {
        tokenFactory = mock(TokenFactory.class);
        factory = new HttpServletRequestUsernameFactory(tokenFactory);
    }
